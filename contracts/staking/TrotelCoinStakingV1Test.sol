...
import "../token/TrotelCoinV1.sol";

contract TrotelCoinStakingV1Test is Initializable, AccessControl {
    ...
    uint256 public sixMonths = 182 days;  // Corrected from 192 days to 182 days
    uint256 public oneYear = 365 days;
    uint256 public fiveMinutes = 5 minutes;  // Added for testing purposes
    ...
    constructor(
        ...
        stakingPeriods[5 minutes] = 0;  // Set APR for 5 minutes duration, change as needed
    }
    ...
    function stake(uint256 amount, uint256 duration) public {
        require(
            duration == 30 days ||
                ...
                duration == 182 days ||
                duration == 365 days ||
                duration == 5 minutes,  // Added 5 minutes as valid duration
            "Invalid duration"
        );
